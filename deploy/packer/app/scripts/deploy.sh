...
docker save taskcluster/taskcluster-proxy:5.0.0 taskcluster/livelog:v4 taskcluster/dind-service:v4.0 taskcluster/relengapi-proxy:$relengapi_proxy_version > ~/docker_worker/docker_worker_images.tar
